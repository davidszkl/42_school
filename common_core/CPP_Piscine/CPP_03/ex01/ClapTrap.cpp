...
ClapTrap::ClapTrap()
{
	std::cout << "Default ClapTrap constructor " << _Name << std::endl;
}
...
ClapTrap::ClapTrap(std::string Name)
{
	...
	_EP		= 10;
	_ATT	= 0;
	std::cout << "Name ClapTrap constructor " << _Name << std::endl;
}

ClapTrap::ClapTrap(ClapTrap const &cpy)
{
	*this = cpy;
	std::cout << "Copy ClapTrap constructor " << _Name << std::endl;
}
